...
import { User, Mail, Phone, MapPin, Building, Calendar, Shield, CheckCircle, Clock } from 'lucide-react';
...
const FieldVisitorProfile: React.FC<FieldVisitorProfileProps> = ({ visitor }) => {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="text-white">
            ...
            <div className="flex items-center mt-1">
              ...
              <span className="text-sm capitalize">{visitor.role.replace('_', ' ')}</span>
              {visitor.approved && (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center text-gray-600">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-gray-500">Last Updated: {formatDate(visitor.updatedAt)}</span>
              </div>
            </div>

            {visitor.setDuty === null && (
              <div className="mt-4 p-3 bg-yellow-50 rounded-md">
                <p className="text-sm text-yellow-700">No active duty assignment</p>
              </div>
            )}
          </div>
        </div>
